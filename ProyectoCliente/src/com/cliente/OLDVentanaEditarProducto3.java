...
public class OLDVentanaEditarProducto3 extends JFrame {
	 ...
	 * Create the frame.
	 */
	public OLDVentanaEditarProducto3(Producto producto) {
		setTitle("Producto");
		...
		String fec = String.valueOf(producto.getFven());

	
		if (fec.isEmpty()==false || !(fec.equals(null)) || !(fec=="")) {
			java.util.Date fv = producto.getFven();
			textFieldFven.setText(formato.format(fv));
		}else{
			textFieldFven.setText("");
		} 
		
		String fe = String.valueOf(producto.getFelab());
		if (fe.isEmpty() == false) {
			textFieldFelab.setText(formato.format(producto.getFelab()));
		} else {
		...
		JComboBox cmbSegmentac = new JComboBox();
		cmbSegmentac.setToolTipText("Lista para seleccionar si el Producto es fraccionable o no");
		cmbSegmentac.setBounds(218, 336, 186, 20);
		Segmentacion segmentac = null;
		cmbSegmentac.addItem(segmentac.N);
		cmbSegmentac.addItem(segmentac.S);
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				producto.setPrecio(Double.valueOf(textFieldPrecio.getText()));
				...
				producto.setPeso(Double.valueOf(textFieldPeso.getText()));
				producto.setVolumen(Double.valueOf(textFieldVolumen.getText()));
				producto.setEstiba(Integer.valueOf(textFieldEstiba.getText()));
				producto.setStkMin(Double.valueOf(textFieldStkMin.getText()));
				producto.setStkTotal(Double.valueOf(textFieldStkTotal.getText()));
				...
				System.out.println("TipoSeg" + tipoSeg);
				...
				System.out.println("famID" + famProd.getId());
				System.out.println("famNom" + famProd.getNombre());
				...
				System.out.println("UsuarioID" + usuProd.getId());
